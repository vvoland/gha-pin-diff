...
func TestMobyPR52217Render(t *testing.T) {
	...
	checks := []struct {
		...
		{"commit row", "| `4d04d5d` | Merge pull request #123 from docker/v4 | @crazy-max | 2025-03-20 |"},
		{"commit row 2", "| `abcdef1` | chore: bump buildx to 0.20 | @crazy-max | 2025-03-19 |"},
		{"commit row 3", "| `1234567` | feat: add support for new driver options | @tonistiigi | 2025-03-18 |"},
	}
