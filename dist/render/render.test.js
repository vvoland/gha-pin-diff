...
describe("comment", () => {
    ...
    it("renders docker image bumps in their own section", () => {
        ...
        assert.ok(got.includes("| [`nginx`](https://hub.docker.com/_/nginx) | `1.25.0` | `1.26.0` |"));
    ...
    it("shows the shortened digest for digest-pinned images", () => {
        ...
        const got = comment(results, []);
        assert.ok(got.includes("| [`nginx`](https://hub.docker.com/_/nginx) | `1.25.0@sha256:aaaaaaaaaaaa` | `1.26.0@sha256:bbbbbbbbbbbb` |"), got);
    });
    it("renders GHCR digest-only updates as images", () => {
        ...
        const got = comment(results, []);
        assert.ok(got.includes("### 🐳 Docker Images"));
        assert.ok(got.includes("| [`ghcr.io/owner/app`](https://github.com/owner/app) | `1.0@sha256:aaaaaaaaaaaa` | `1.0@sha256:bbbbbbbbbbbb` |"), got);
